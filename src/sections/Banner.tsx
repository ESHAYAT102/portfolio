        ...
        <div className="max-w-268 mx-0 min-[1000px]:mx-38 w-full border-b border-l-0 min-[1000px]:border-l border-r-0 min-[1000px]:border-r border-stone-600/60">
          <div className="p-20">
            ...
            <p className="text-stone-300/70">
              ...
              designer, and I love to code. I've always been into computer. I
              was fascinated by the technology. Like{" "}
              <span className="relative group">
              ...
              I can tell a box made out of metal, silicon and other stuff and it
              literally does what I say. Also I used to draw in MS Paint a lot
              as a kid, so the designer perspective started from there. I really
              loved the concept of telling the computer to do something for me,
              which got me interested in programming so much. I'm focusing on
              developing tools for the developer community to make their
              experience faster and more automated.
            </p>
          </div>
        </div>
      </div>
